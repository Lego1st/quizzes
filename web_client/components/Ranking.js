...
class Ranking extends React.Component {
	...
	handleData(fetch_data) {
		...
		for (let key in fetch_data) {
			...
			newData.push(<li key={key} className="list-group-item" style={{backgroundColor: "#f7f7f7"}} ><strong>{CATEGORY_CODE[key]} </strong><span className="badge badge-pill badge-danger"> {rank[0] + 1}{num} </span> </li>)
		}
